...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        homeViewController.tabBarItem.image = UIImage.init(named: "Icon-Home")
        homeViewController.tabBarItem.title = "Home"
        let homeNavigationController = UINavigationController.init(rootViewController: homeViewController)
        
        let favoriteViewController = FavoriteViewController.init(nibName: nil, bundle: nil)
        favoriteViewController.tabBarItem.image = UIImage.init(named: "Icon-Favorite")
        ...
        tabBarController.addChildViewController(favoriteNavigationController)
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "MaiCoinAssignment")
